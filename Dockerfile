...
# https://github.com/qycnet/palworld-server-tool-main/releases/download/v0.9.4/map.zip
RUN curl -L -o map.zip https://github.com/qycnet/palworld-server-tool-main/releases/download/v0.9.4/map.zip
